...
import { l as A, P as V, __tla as __tla_0 } from "./index-DOVgLsjT.js";
let ne;
let __tla = Promise.all([
  ...
  const re = "" + new URL("chat_browser_bg-DNUWMdgs.wasm", import.meta.url).href, oe = async (e = {}, n) => {
    let t;
  ...
  function ie(e, n) {
    return G += n, G >= se && (D = new TextDecoder("utf-8", {
      ignoreBOM: true,
      fatal: true
    }), D.decode(), G = n), D.decode(C().subarray(e, e + n));
  }
  function w(e, n) {
    return e = e >>> 0, ie(e, n);
  }
  ...
  function m(e, n, t) {
    if (t === void 0) {
      ...
      return C().subarray(y, y + u.length).set(u), p = u.length, y;
    }
    ...
    if (a !== _) {
      ...
      const u = C().subarray(o + a, o + _), y = O.encodeInto(e, u);
...
${e.stack}` : _;
  ...
  function le(e, n, t) {
    s.__wbindgen_export_10(e, n, c(t));
  }
  function he(e, n, t, _) {
  ...
  class L {
    ...
    neighbors() {
      try {
        ...
        var n = f().getInt32(o + 4 * 0, true), t = f().getInt32(o + 4 * 1, true), _ = U(n, t).slice();
  ...
  function n_(e, n) {
    const t = ae(e, n, 1510, ge);
    return c(t);
  }
  function t_(e, n) {
    const t = B(e, n, 2617, fe);
    return c(t);
  }
  function __(e, n) {
    const t = B(e, n, 692, ue);
    return c(t);
  }
  function r_(e, n) {
    const t = T(e, n);
  ...
  const i = await oe({
    "./chat_browser_bg.js": {
      ...
      __wbg_warn_479b8bbb8337357b: Ut,
      ...
      __wbg_wasClean_ffb515fbcbcbdd3d: Bt,
      ...
      __wbg_data_9ab529722bcc4e6c: He,
      __wbg_sethighwatermark_3d5961f834647d41: ut,
      __wbg_byobRequest_2c036bceca1e6037: Ae,
      ...
      __wbg_read_bc925c758aa4d897: Hn,
      ...
      __wbg_then_e22500defe16819f: Ct,
      __wbg_then_b33a773d723afa3e: At,
      ...
      __wbg_wbindgenisundefined_c4b71d073b92f3c5: Gt,
      ...
      __wbg_wbindgenjsvallooseeq_9bec8c9be826bed1: Ht,
    ...
    __wbg_intounderlyingsource_free: C_,
  ...
  ne = class {
    ...
    static async create() {
      ...
      return A.info(`Iroh node spawned. our node id: ${n.node_id()}`), new ne(n);
    }
