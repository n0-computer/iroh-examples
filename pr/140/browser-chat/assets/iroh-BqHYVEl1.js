...
import { l as A, P as V, __tla as __tla_0 } from "./index-CwtrEEGD.js";
let ne;
let __tla = Promise.all([
  ...
  const re = "" + new URL("chat_browser_bg-5UwXmlja.wasm", import.meta.url).href, oe = async (e = {}, n) => {
    let t;
...
${e.stack}` : _;
  ...
  function r_(e, n) {
    const t = be(e, n, 1565, we);
    return s(t);
  }
  function o_(e, n) {
    const t = C(e, n, 1693, de);
    return s(t);
  }
  function c_(e, n) {
    const t = C(e, n, 2755, pe);
    return s(t);
  }
  function s_(e, n) {
    const t = T(e, n);
