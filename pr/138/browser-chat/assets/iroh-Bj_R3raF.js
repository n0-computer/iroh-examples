...
import { l as C, P as V, __tla as __tla_0 } from "./index-C5v9i7BB.js";
let ne;
let __tla = Promise.all([
  ...
  const re = "" + new URL("chat_browser_bg-CpXJSYjo.wasm", import.meta.url).href, oe = async (e = {}, n) => {
    let t;
  ...
  function ie(e, n) {
    return G += n, G >= se && (D = new TextDecoder("utf-8", {
      ignoreBOM: true,
      fatal: true
    }), D.decode(), G = n), D.decode(A().subarray(e, e + n));
  }
  function w(e, n) {
    return e = e >>> 0, ie(e, n);
  }
...
${e.stack}` : _;
  ...
  function n_(e, n) {
    const t = ae(e, n, 1510, de);
    return c(t);
  }
  function t_(e, n) {
    const t = U(e, n, 2617, le);
    return c(t);
  }
  function __(e, n) {
    const t = U(e, n, 692, ue);
    return c(t);
  }
  function r_(e, n) {
    const t = T(e, n);
  ...
  const i = await oe({
    "./chat_browser_bg.js": {
      ...
      __wbg_clearTimeout_86721db0036bea98: ze,
      ...
      __wbg_close_6437264570d2d37f: We,
      ...
      __wbg_wbindgendebugstring_99ef257a3ddda34d: Wt,
      ...
      __wbg_wbindgencbdrop_eb10308566512b88: zt,
